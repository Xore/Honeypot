...
rule AutoGen_Honeypot_xore_HashOnly
{
    meta:
        description = "Auto-generated hash-only rule for honeypot_xore (no discriminating strings survived boilerplate filtering)"
        author      = "honeypot-bot"
        date        = "2026-08-02"
        auto_generated = true
        hash_only   = true
